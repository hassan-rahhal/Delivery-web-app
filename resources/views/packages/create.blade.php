...
<div class="container">
    <h2 class="mb-4">Create New Package</h2>
    ...
    <form action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data" id="packageForm">
        ...
        <div class="form-group mb-3">
            ...
            <select name="measurement_unit" id="measurement_unit" class="form-control @error('measurement_unit') is-invalid @enderror" required>
                ...
                <option value="cm" {{ old('measurement_unit') == 'cm' ? 'selected' : '' }}>cm</option>
                <option value="m" {{ old('measurement_unit') == 'm' ? 'selected' : '' }}>m</option>
                <option value="inch" {{ old('measurement_unit') == 'inch' ? 'selected' : '' }}>inch</option>
            </select>
        ...
        <div class="form-group mb-4">
            ...
            <div id="imagePreview" class="mt-2" style="display:none;">
                <img id="previewImg" src="" alt="Preview" style="width:150px; height:150px; object-fit:cover; border-radius:8px; border:2px solid #dee2e6;">
            </div>
        </div>
