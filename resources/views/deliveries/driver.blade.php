...
<div class="container">
    ...
    <form method="GET" action="{{ route('driver.deliveries') }}" class="mb-4">
        <div class="row">
            <div class="col-md-4">
    ...
    <option value="cancelled" {{ request('status') == 'cancelled' ? 'selected' : '' }}>Cancelled</option>
            ...
            <div class="col-md-4">
                ...
                <select name="sort_by" id="sort_by" class="form-control">
                    ...
                    <option value="time_asc" {{ request('sort_by') == 'time_asc' ? 'selected' : '' }}>Time (Earliest First)</option>
                    <option value="time_desc" {{ request('sort_by') == 'time_desc' ? 'selected' : '' }}>Time (Latest First)</option>
